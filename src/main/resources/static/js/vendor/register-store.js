document.addEventListener('DOMContentLoaded', function() {
	...
	// Xử lý form submit - SỬA LẠI PHẦN NÀY
	// Xử lý form submit - SỬA LẠI
	form.addEventListener('submit', function(e) {
	    ...
	    // Nếu form hợp lệ, tiến hành submit BẰNG FORM THÔNG THƯỜNG (không dùng AJAX)
	    showLoading();
	    submitBtn.disabled = true;
	    btnText.textContent = 'Đang xử lý...';

	    // Submit form thông thường (không dùng AJAX) để redirect hoạt động đúng
	    form.submit();
	});
