...
public class NguoiDungServiceImpl implements NguoiDungService {
    ...
    public NguoiDung lockUser(Integer id, String lyDoKhoa) {
        ...
        // Nếu người dùng có vai trò VENDOR, khóa tất cả cửa hàng của họ
        if (nguoiDung.getVaiTro() != null && "VENDOR".equalsIgnoreCase(nguoiDung.getVaiTro().getMaVaiTro())) {
            List<CuaHang> cuaHangs = cuaHangRepository.findByNguoiDung(nguoiDung);
            for (CuaHang cuaHang : cuaHangs) {
                cuaHang.setTrangThai(false);
                cuaHang.setLyDoKhoa(lyDoKhoa);
    ...
    public NguoiDung unlockUser(Integer id) {
        ...
        // Nếu người dùng có vai trò VENDOR, mở khóa tất cả cửa hàng của họ
        if (nguoiDung.getVaiTro() != null && "VENDOR".equalsIgnoreCase(nguoiDung.getVaiTro().getMaVaiTro())) {
            List<CuaHang> cuaHangs = cuaHangRepository.findByNguoiDung(nguoiDung);
            for (CuaHang cuaHang : cuaHangs) {
                cuaHang.setTrangThai(true);
